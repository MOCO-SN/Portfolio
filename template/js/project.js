window.projects = [
  {
    ...
    demoLink: "https://iirslms.mocosn.in/",
  ...
  },
  {
    ...
    codeLink: "/error_pages/error.html",
    details:
      "A fully responsive website built with modern HTML5, CSS3, Python and JavaScript. to getting information about phone number.",
    screenshots: [
  ...
  },
  {
    ...
    description:
      "A modern web platform for mod application submissions and management.",
    image:
      "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=400&h=200&fit=crop&auto=format",
    demoLink: "https://software.mocosn.in/",
    codeLink: "/error_pages/error.html",
    details:
      "A fully responsive website built with modern HTML5, CSS3, and JavaScript. Features include user authentication, application form submission, admin dashboard, and real-time application tracking. The platform streamlines the mod application process with an intuitive interface and secure data handling.",
    screenshots: [
      "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=300&fit=crop&auto=format",
  ...
  },
  {
    ...
    description:
      "A comprehensive Java-based login system for educational institutions.",
    image:
      "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400&h=200&fit=crop&auto=format",
    demoLink: "https://mangeschool.mocosn.in/",
    codeLink: "/error_pages/error.html",
    details:
      "A robust school management login portal developed purely in Java. Features include multi-user role authentication (students, teachers, admin), password encryption, session management, and a clean, intuitive GUI. Built with Swing for the interface and file-based storage for user data.",
    screenshots: [
  ...
  {
    id: 14,
    title: "College Personal Store Website.",
    description: "Exploring the bihar with Tourism website.",
    image:
      "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=400&h=200&fit=crop&auto=format",
    demoLink: "https://www.bgbazaar.shop/",
    codeLink: "/error_pages/error.html",
    details:
      "A sophisticated login system leveraging Java for UI and C++ native methods for core authentication logic. Implements JNI (Java Native Interface) for seamless integration between Java and C++. Features include biometric authentication simulation, hardware-level security checks, and encrypted credential storage.",
    screenshots: [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?w=400&h=200&fit=crop&auto=format",
    demoLink: "https://thisnavneet.in/",
    codeLink: "/error_pages/error.html",
    details:
      "A personal profile website for showcasing portfolio, skills, and achievements. Features include responsive design, project gallery, contact form, and social media integration. Built with modern web technologies to provide an engaging user experience.",
    screenshots: [
      "https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=600&h=300&fit=crop&auto=format",
    ],
  ...
  },
  {
    ...
    title: "SBCM SCHOOL",
    description:
      "Complete modding toolkit for Android applications with creator features.",
    image:
      "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=400&h=200&fit=crop&auto=format",
    demoLink: "https://sbcm.mocosn.in/",
    codeLink: "/error_pages/error.html",
    details:
      "A powerful modding utility suite featuring mod downloader, custom mod creator, APK decompiler, and resource editor. Includes tutorials for beginners and advanced tools for experienced modders. Supports various game engines and provides template-based mod creation.",
    screenshots: [
      "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1526498460520-4c246339dccb?w=600&h=300&fit=crop&auto=format",
    ],
    techStack: ["Java", "XML", "APKTool", "Smali"],
    createdAt: "June 2025",
  },
  {
    id: 6,
    ...
    screenshots: [
      "https://images.unsplash.com/photo-1611606063065-ee7946f0787a?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600&h=300&fit=crop&auto=format",
    ],
    techStack: ["HTML5", "CSS3", "JavaScript", "Firebase", "WebSockets"],
    createdAt: "May 2025",
  },
  {
    id: 7,
    ...
    details:
      "A sophisticated mod menu framework allowing seamless library injection into APKs. Combines Java UI components with C++ native hooks for maximum performance. Features include memory editing, function hooking, and a plugin system for extending functionality.",
    screenshots: [
      "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1555066932-e78dd8fb77bb?w=600&h=300&fit=crop&auto=format",
    ],
  ...
  },
  {
    ...
    title: "MOCOSN TOOLS",
    description:
      "Next-gen mod menu with latest hooks and optimization updates.",
    image:
      "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400&h=200&fit=crop&auto=format",
    demoLink: "https://www.mediafire.com/folder/29ghu9xseixrw/MOCOSN_TOOLS",
    codeLink: "/error_pages/error.html",
    details:
      "The latest evolution of MSN mod menu featuring file 0B92 implementation and version 0B50 optimizations. Includes enhanced hook stability, improved memory management, and new feature additions. Supports the latest Android versions and provides comprehensive debugging tools.",
    screenshots: [
      "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1611162618071-b39a2ec055fb?w=600&h=300&fit=crop&auto=format",
    ],
    techStack: ["Java", "C++", "ARM Assembly", "GDB"],
    createdAt: "May 2025",
  },
  {
    id: 9,
    ...
    description:
      "College project - Autonomous surveying vehicle with multi-sensor integration.",
    image:
      "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=400&h=200&fit=crop&auto=format",
    demoLink: "/error_pages/error.html",
    codeLink: "/error_pages/error.html",
    details:
      "An innovative college project developing an unmanned vehicle capable of autonomous surveying. Integrates GPS navigation, obstacle detection sensors, and real-time data collection. Features include remote monitoring, data logging, and automated route planning. Currently in active development with promising results.",
    screenshots: [
      "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&h=300&fit=crop&auto=format",
    ],
    techStack: ["Arduino", "Raspberry Pi", "Python", "C++", "GPS Module"],
  ...
  },
  {
    ...
    title: "Radar System",
    description:
      "College project - Arduino-based radar system with real-time visualization.",
    image:
      "https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=400&h=200&fit=crop&auto=format",
    demoLink: "/error_pages/error.html",
    codeLink: "/error_pages/error.html",
    details:
      "An engineering college project developing a functional radar system using Arduino and ultrasonic sensors. Features include 180-degree scanning, real-time object detection, distance calculation, and computer visualization. The system displays radar sweeps on a connected display with detected objects plotted in real-time.",
    screenshots: [
      "https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=600&h=300&fit=crop&auto=format",
      "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=600&h=300&fit=crop&auto=format",
    ],
    techStack: [
      "Arduino",
      "Ultrasonic Sensor",
